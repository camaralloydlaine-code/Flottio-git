...
export default function InscriptionFlottePage() {
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="glass-card p-8 flex flex-col gap-6">
        ...
        <form className="flex flex-col gap-4">
          ...
          <Link href="/onboarding" className="w-full magnetic-btn bg-surface border border-border text-white py-3.5 rounded-xl font-sans font-bold text-sm flex items-center justify-center gap-2 hover:bg-white/5 transition-colors">
